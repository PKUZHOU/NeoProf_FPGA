	rspfifo u0 (
		.data    (_connected_to_data_),    //   input,  width = 560,  fifo_input.datain
		...
		.q       (_connected_to_q_),       //  output,  width = 560, fifo_output.dataout
		.rdusedw (_connected_to_rdusedw_), //  output,    width = 6,            .rdusedw
