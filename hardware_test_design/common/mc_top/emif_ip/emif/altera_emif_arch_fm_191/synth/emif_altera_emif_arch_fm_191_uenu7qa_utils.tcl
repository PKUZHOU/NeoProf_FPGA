...
proc emif_altera_emif_arch_fm_191_uenu7qa_index_in_collection { col j } {
   set i 0
...
proc emif_altera_emif_arch_fm_191_uenu7qa_get_clock_to_pin_name_mapping {} {
   set result [list]
   ...
   foreach_in_collection clock $clocks_collection {
      ...
      set first_index [emif_altera_emif_arch_fm_191_uenu7qa_index_in_collection $clock_target 0]
...
proc emif_altera_emif_arch_fm_191_uenu7qa_get_clock_name_from_pin_name { pin_name } {
   set table [emif_altera_emif_arch_fm_191_uenu7qa_get_clock_to_pin_name_mapping]
   foreach entry $table {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_find_all_keepers { mystring } {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_round_3dp { x } {
   return [expr { round($x * 1000) / 1000.0  } ]
}

proc emif_altera_emif_arch_fm_191_uenu7qa_get_current_timequest_report_folder {} {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_get_timequest_name {hier_name} {
   set sta_name $hier_name
   return $sta_name
}

proc emif_altera_emif_arch_fm_191_uenu7qa_are_entity_names_on { } {
   return [set_project_mode -is_show_entity]
}

proc emif_altera_emif_arch_fm_191_uenu7qa_get_core_instance_list {corename} {
   ...
   if {$::io_only_analysis == 1}  {
      ...
      set full_instance_list [emif_altera_emif_arch_fm_191_uenu7qa_get_core_full_instance_list $corename]
      set instance_list [list]

      foreach inst $full_instance_list {
         set sta_name [emif_altera_emif_arch_fm_191_uenu7qa_get_timequest_name $inst]
...
proc emif_altera_emif_arch_fm_191_uenu7qa_get_or_add_generated_clock {args} {
   ...
   set clock_name [emif_altera_emif_arch_fm_191_uenu7qa_get_clock_name_from_pin_name $opts(-target)]
   ...
   if {[string compare -nocase $clock_name ""] == 0} {
      ...
      if {[get_collection_size $nets] > 0} {
         ...
         set clock_name [emif_altera_emif_arch_fm_191_uenu7qa_get_clock_name_from_pin_name $pin_name]
...
proc emif_altera_emif_arch_fm_191_uenu7qa_get_core_full_instance_list {corename} {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_traverse_fanin_up_to_depth { node_id match_command edge_type results_array_name depth} {
   ...
   for {set i 0} {$i != $number_of_fanin_edges} {incr i} {
      ...
      if {$match_command == "" || [eval $match_command $fanin_id] != 0} {
         ...
         emif_altera_emif_arch_fm_191_uenu7qa_traverse_fanin_up_to_depth $fanin_id $match_command $edge_type results [expr {$depth - 1}]
      }
   }
}

proc emif_altera_emif_arch_fm_191_uenu7qa_is_node_type_pin { node_id } {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_get_pll_clock_name { clock_id } {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_get_names_in_collection { col } {
   set res [list]
...
proc emif_altera_emif_arch_fm_191_uenu7qa_format_3dp { x } {
   return [format %.3f $x]
}

proc emif_altera_emif_arch_fm_191_uenu7qa_get_colours { x y } {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_max_in_collection { col attribute } {
   set i 0
   set max 0
   foreach_in_collection path $col {
      if {$i == 0} {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_min_in_collection { col attribute } {
   set i 0
   set min 0
   foreach_in_collection path $col {
      if {$i == 0} {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_min_in_collection_to_clock { col attribute clock } {
   set i 0
   set min ERROR
   foreach_in_collection path $col {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_min_in_collection_from_clock { col attribute clock } {
   set i 0
   set min ERROR
   foreach_in_collection path $col {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_min_in_collection_to_name { col attribute name } {
   set i 0
   set min 0
   foreach_in_collection path $col {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_min_in_collection_from_name { col attribute name } {
   set i 0
   set min 0
   foreach_in_collection path $col {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_max_in_collection_to_name { col attribute name } {
   set i 0
   set max 0
   foreach_in_collection path $col {
      if {[get_node_info -name [get_path_info $path -to]] == $name} {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_max_in_collection_from_name { col attribute name } {
   set i 0
   set max 0
   foreach_in_collection path $col {
      if {[get_node_info -name [get_path_info $path -from]] == $name} {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_min_in_collection_to_name2 { col attribute name } {
   set i 0
   set min 0
   foreach_in_collection path $col {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_min_in_collection_from_name2 { col attribute name } {
   set i 0
   set min 0
   foreach_in_collection path $col {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_max_in_collection_to_name2 { col attribute name } {
   set i 0
   set max 0
   foreach_in_collection path $col {
      if {[regexp $name [get_node_info -name [get_path_info $path -to]]]} {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_max_in_collection_from_name2 { col attribute name } {
   set i 0
   set max 0
   foreach_in_collection path $col {
      if {[regexp $name [get_node_info -name [get_path_info $path -from]]]} {
...
proc emif_altera_emif_arch_fm_191_uenu7qa_sort_proc {a b} {
   set idxs [list 1 2 0]
   foreach i $idxs {
      set ai [lindex $a $i]
      set bi [lindex $b $i]
...
proc emif_altera_emif_arch_fm_191_uenu7qa_gcd {p q} {
   set p [expr {abs($p)}]
   set q [expr {abs($q)}]
   while {$q != 0} {
      set r [expr {$p % $q}]
...
proc emif_altera_emif_arch_fm_191_uenu7qa_traverse_atom_path {atom_id atom_oport_id path} {
      ...
      if {[get_atom_node_info -key type -node $atom_id] == $atom_type} {
         if {$next_direction == "end"} {
            ...
            if {$atom_iport != -1} {
               ...
               set result [emif_altera_emif_arch_fm_191_uenu7qa_traverse_atom_path $source_atom $source_oterm [lrange $path 1 end]]
            } elseif {$atom_optional == "-optional"} {
               set result [emif_altera_emif_arch_fm_191_uenu7qa_traverse_atom_path $atom_id $atom_oport_id [lrange $path 1 end]]
            }
            ...
            if {$atom_oport != -1} {
               ...
               foreach dest $oport_fanout {
                  ...
                  set fanout_result_list [emif_altera_emif_arch_fm_191_uenu7qa_traverse_atom_path $dest_atom -1 [lrange $path 1 end]]
...
proc emif_altera_emif_arch_fm_191_uenu7qa_get_operating_conditions_number {} {
