...
if { ! [timing_netlist_exist] } {
   ...
   source "$script_dir/emif_altera_emif_arch_fm_191_uenu7qa_report_timing_core.tcl"
   if { ! [timing_netlist_exist] } {
...
emif_altera_emif_arch_fm_191_uenu7qa_initialize_ddr_db ddr_db var
...
foreach inst $instances {
   ...
   if {[llength $instances] <= 1} {
      set fbasename "${::GLOBAL_emif_altera_emif_arch_fm_191_uenu7qa_corename}"
   } else {
      set fbasename "${::GLOBAL_emif_altera_emif_arch_fm_191_uenu7qa_corename}_${inst_id}"
   }
   ...
   emif_altera_emif_arch_fm_191_uenu7qa_perform_core_analysis $opcname $inst pins var summary


   set summary [lsort -command emif_altera_emif_arch_fm_191_uenu7qa_sort_proc $summary]

   post_message -type info "Core: ${::GLOBAL_emif_altera_emif_arch_fm_191_uenu7qa_corename} - Instance: $inst"
   ...
   foreach summary_line $summary {
      ...
      if {$su != "--"} {
         set su [ emif_altera_emif_arch_fm_191_uenu7qa_round_3dp $su]
      }
      if {$hold != "--"} {
         set hold [ emif_altera_emif_arch_fm_191_uenu7qa_round_3dp $hold]
      }
