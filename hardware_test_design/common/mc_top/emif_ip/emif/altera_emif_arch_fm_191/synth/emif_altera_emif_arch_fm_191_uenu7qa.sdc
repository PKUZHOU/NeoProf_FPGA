...
source "$script_dir/emif_altera_emif_arch_fm_191_uenu7qa_ip_parameters.tcl"
source "$script_dir/emif_altera_emif_arch_fm_191_uenu7qa_parameters.tcl"
source "$script_dir/emif_altera_emif_arch_fm_191_uenu7qa_pin_map.tcl"
...
set entity_names_on [ emif_altera_emif_arch_fm_191_uenu7qa_are_entity_names_on ]
...
set pll_multiplier [ emif_altera_emif_arch_fm_191_uenu7qa_round_3dp [expr $var(PHY_MEM_CLK_FREQ_MHZ)/$var(PHY_REF_CLK_FREQ_MHZ)] ]
set vco_multiplier [expr int($var(PHY_REF_CLK_FREQ_PS)/$var(PHY_VCO_FREQ_PS))]

# Half of memory clock cycle
set half_period [ emif_altera_emif_arch_fm_191_uenu7qa_round_3dp [ expr $var(UI) / 2.0 ] ]

# Half of reference clock
set ref_period      [ emif_altera_emif_arch_fm_191_uenu7qa_round_3dp [ expr $var(PHY_REF_CLK_FREQ_PS)/1000.0] ]
set ref_half_period [ emif_altera_emif_arch_fm_191_uenu7qa_round_3dp [ expr $ref_period / 2.0 ] ]

# Other clock periods
set tCK_AFI     [ emif_altera_emif_arch_fm_191_uenu7qa_round_3dp [ expr 1000.0/$var(PHY_MEM_CLK_FREQ_MHZ)*$var(USER_CLK_RATIO) ] ]
set tCK_C2P_P2C [ emif_altera_emif_arch_fm_191_uenu7qa_round_3dp [ expr 1000.0/$var(PHY_MEM_CLK_FREQ_MHZ)*$var(C2P_P2C_CLK_RATIO) ] ]
set tCK_PHY     [ emif_altera_emif_arch_fm_191_uenu7qa_round_3dp [ expr 1000.0/$var(PHY_MEM_CLK_FREQ_MHZ)*$var(PHY_HMC_CLK_RATIO) ] ]

# Asymmetric uncertainties on address and command paths
set ac_min_delay [ emif_altera_emif_arch_fm_191_uenu7qa_round_3dp [ expr - $var(tIH) + $var(CA_TO_CK_BD_PKG_SKEW) ]]
set ac_max_delay [ emif_altera_emif_arch_fm_191_uenu7qa_round_3dp [ expr   $var(tIS) + $var(CA_TO_CK_BD_PKG_SKEW) ]]
...
if { ! [ info exists emif_altera_emif_arch_fm_191_uenu7qa_sdc_cache ] } {
   emif_altera_emif_arch_fm_191_uenu7qa_initialize_ddr_db emif_altera_emif_arch_fm_191_uenu7qa_ddr_db var
   set emif_altera_emif_arch_fm_191_uenu7qa_sdc_cache 1
} else {
   if { $debug } {
...
set instances [ array names emif_altera_emif_arch_fm_191_uenu7qa_ddr_db ]
foreach { inst } $instances {
   if { [ info exists pins ] } {
      unset pins
   }
   array set pins $emif_altera_emif_arch_fm_191_uenu7qa_ddr_db($inst)
   ...
   set ref_clock_exists [ emif_altera_emif_arch_fm_191_uenu7qa_does_ref_clk_exist $pins(pll_ref_clock) ]
   ...
   set pins(ref_clock_name) [emif_altera_emif_arch_fm_191_uenu7qa_get_clock_name_from_pin_name $pins(pll_ref_clock)]
   ...
   foreach { vco_clock } $pins(pll_vco_clock) {
      ...
      set local_pll_vco_clk_${i_vco_clock} [ emif_altera_emif_arch_fm_191_uenu7qa_get_or_add_generated_clock \
         -target $vco_clock \
   ...
   if {! $var(IS_HPS)} {
      ...
      set local_pll_master_vco_clock [ emif_altera_emif_arch_fm_191_uenu7qa_get_or_add_generated_clock \
      ...
      if {$pins(master_core_usr_clock) != ""} {
         ...
         set local_core_usr_clock [ emif_altera_emif_arch_fm_191_uenu7qa_get_or_add_generated_clock \
      ...
      if {$pins(master_core_usr_clock_sec) != ""} {
         ...
         set local_core_usr_clock_sec [ emif_altera_emif_arch_fm_191_uenu7qa_get_or_add_generated_clock \
      ...
      if {$pins(master_core_usr_half_clock) != ""} {
         ...
         set local_core_usr_half_clock [ emif_altera_emif_arch_fm_191_uenu7qa_get_or_add_generated_clock \
            -target $master_core_clock \
            -name "${pins(master_instname)}_${name}" \
            -source $pins(master_vco_clock) \
            -multiply_by 1 \
      ...
      if {$pins(master_core_afi_clock) != ""} {
         ...
         set local_core_afi_clock [ emif_altera_emif_arch_fm_191_uenu7qa_get_or_add_generated_clock \
            -target $master_core_clock \
            -name "${pins(master_instname)}_${name}" \
            -source $pins(master_vco_clock) \
            -multiply_by 1 \
      ...
      if {$pins(master_core_dft_cpa_1_clock) != ""} {
         ...
         set local_core_dft_cpa_1_clock [ emif_altera_emif_arch_fm_191_uenu7qa_get_or_add_generated_clock \
            -target $master_core_clock \
            -name "${pins(master_instname)}_${name}" \
            -source $pins(master_vco_clock) \
            -multiply_by 1 \
      ...
      if {$pins(master_cal_master_clk) != ""} {
         ...
         if {[get_collection_size $pll_cal_master_clk] > 0} {
            ...
            set local_cal_master_clock [ emif_altera_emif_arch_fm_191_uenu7qa_get_or_add_generated_clock \
               -target $master_core_clock \
               -name "${pins(master_instname)}_${name}" \
               -source $pins(master_vco_clock) \
               -multiply_by 1  \
      ...
      if {$pins(master_cal_slave_clk) != ""} {
         ...
         if {[get_collection_size $pll_cal_slave_clk] > 0} {
            ...
            set local_cal_slave_clock [ emif_altera_emif_arch_fm_191_uenu7qa_get_or_add_generated_clock \
               -target $master_core_clock \
               -name "${pins(master_instname)}_${name}" \
               -source $pins(master_vco_clock) \
               -multiply_by 1  \
      ...
      for {set i_extra_clk 0} {$i_extra_clk < $var(PLL_NUM_OF_EXTRA_CLKS)} {incr i_extra_clk} {
         ...
         if {[get_collection_size $pll_extra_clk] > 0} {
            ...
            set local_pll_extra_clock [ emif_altera_emif_arch_fm_191_uenu7qa_get_or_add_generated_clock \
               -target $master_core_clock \
               -name "${pins(master_instname)}_${name}" \
               -source $pins(master_vco_clock) \
               -multiply_by 1  \
   ...
   foreach { phy_clock } $pins(pll_phy_clock) {
      ...
      set local_phy_clk_${i_phy_clock} [ emif_altera_emif_arch_fm_191_uenu7qa_get_or_add_generated_clock \
         -target $phy_clock \
   ...
   foreach { phy_clock_l } $pins(pll_phy_clock_l) {
      ...
      set local_phy_clk_l_${i_phy_clock_l} [ emif_altera_emif_arch_fm_191_uenu7qa_get_or_add_generated_clock \
         -target $phy_clock_l \
   ...
   foreach_in_collection wf_clock $write_fifo_clk {
      set vco_clock_id [emif_altera_emif_arch_fm_191_uenu7qa_get_vco_clk_id $wf_clock var]
      if {$vco_clock_id == -1} {
         post_message -type critical_warning "Failed to find VCO clock"
      } else {
         set local_wf_clk_${i_wf_clock} [ emif_altera_emif_arch_fm_191_uenu7qa_get_or_add_generated_clock \
   ...
   if {!$var(IS_HPS) && ($fit_flow == 1 || $sta_flow == 1)} {
      ...
      set p2c_c2p_multi_tile_clock_uncertainty [emif_altera_emif_arch_fm_191_uenu7qa_get_p2c_c2p_clock_uncertainty $inst var]

      # Get extra periphery clock uncertainty
      set periphery_clock_uncertainty [list]
      emif_altera_emif_arch_fm_191_uenu7qa_get_periphery_clock_uncertainty periphery_clock_uncertainty var

      # Get Fitter overconstraints
      if {$fit_flow == 1} {
         emif_altera_emif_arch_fm_191_uenu7qa_get_periphery_overconstraints periphery_overconstraints_st periphery_overconstraints_mt var
      } else {
      ...
      emif_altera_emif_arch_fm_191_uenu7qa_get_core_clock_uncertainty core_clock_uncertainty var

      # Get Fitter overconstraints
      if {$fit_flow == 1} {
         emif_altera_emif_arch_fm_191_uenu7qa_get_core_overconstraints core_overconstraints var
      } else {
...
add_ddr_report_command "source [list [file join [file dirname [info script]] ${::GLOBAL_emif_altera_emif_arch_fm_191_uenu7qa_corename}_report_timing.tcl]]"
