...
#    * The helper routines are defined in intel_rtile_cxl_top_cxltyp3_ed_altera_iopll_1931_lsetw4a_pin_map.tcl
#
# NOTE
# ----
...
source "$script_dir/intel_rtile_cxl_top_cxltyp3_ed_altera_iopll_1931_lsetw4a_parameters.tcl"
source "$script_dir/intel_rtile_cxl_top_cxltyp3_ed_altera_iopll_1931_lsetw4a_pin_map.tcl"
...
if {[info exists ::GLOBAL_top_intel_rtile_cxl_top_cxltyp3_ed_altera_iopll_1931_lsetw4a_corename_ai_pll_db]} {
    # Clean-up stale content
    unset ::GLOBAL_top_intel_rtile_cxl_top_cxltyp3_ed_altera_iopll_1931_lsetw4a_corename_ai_pll_db
}
if {[catch {ai_initialize_pll_db ::GLOBAL_top_intel_rtile_cxl_top_cxltyp3_ed_altera_iopll_1931_lsetw4a_corename_ai_pll_db} err_initializing_db]} {
...
# following loop
set instances [ array names ::GLOBAL_top_intel_rtile_cxl_top_cxltyp3_ed_altera_iopll_1931_lsetw4a_corename_ai_pll_db ]
foreach { inst } $instances {
    ...
    lassign $::GLOBAL_top_intel_rtile_cxl_top_cxltyp3_ed_altera_iopll_1931_lsetw4a_corename_ai_pll_db($inst) base_clock_data_dict gen_clock_data_dict
