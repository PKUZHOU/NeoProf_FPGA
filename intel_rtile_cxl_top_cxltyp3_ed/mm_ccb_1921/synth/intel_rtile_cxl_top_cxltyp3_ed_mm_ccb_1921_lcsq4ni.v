...
`timescale 1 ns / 1 ns
module intel_rtile_cxl_top_cxltyp3_ed_mm_ccb_1921_lcsq4ni 
#(
...
(
    ...
    intel_rtile_cxl_top_cxltyp3_ed_mm_ccb_st_dc_fifo_1921_4asniea #(
        .SYMBOLS_PER_BEAT (1),
   ...
   endgenerate
    ...
    // --------------------------------------
    (* altera_attribute = "-name ALLOW_ANY_RAM_SIZE_FOR_RECOGNITION ON" *) 
    intel_rtile_cxl_top_cxltyp3_ed_mm_ccb_st_dc_fifo_1921_wen3bsa #(
        .SYMBOLS_PER_BEAT   (1),
